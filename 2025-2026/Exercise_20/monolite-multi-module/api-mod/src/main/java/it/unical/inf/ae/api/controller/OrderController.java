...
public class OrderController {
    ...
    public ResponseEntity<OrderDto> getOrderById(@Parameter(description = "ID dell'ordine") @PathVariable("id") Long id) {
    ...
    public ResponseEntity<Page<OrderDto>> getOrdersByUserId(
            @Parameter(description = "ID dell'utente") @PathVariable("userId") Long userId,

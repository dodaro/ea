    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // .requestMatchers(HttpMethod.POST, "/product-api/products").hasAllRoles("ADMIN", "BASIC")
                        // RBAC fine-grained sui controller via @PreAuthorize. /auth/logout richiede auth.

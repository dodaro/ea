...
public class MethodInheritanceApp {
    class BaseClass {
    ...
    public static void main(String[] args) throws NoSuchMethodException{
        ...
        if (metodoInfoSubClass != null) {
            ...
            System.out.println("\t L'annotazione @Inherited in Java funziona solo per le annotazioni applicate a livello di classe, non a livello di metodo");
        }
    }
}

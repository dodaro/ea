...
public class StudentController {
  ...
  public ResponseEntity<List<StudentDto>> all() {
    ...
    List<StudentDto> allSorted = studentService.getAllSorted();
  ...
  // localhost:8080/student-api/students/test?name=ciccio
  ...
  public ResponseEntity<StudentBasicDto> update(@PathVariable("idStudent") Long id, @RequestBody StudentDto studentDto) {
    StudentBasicDto s = studentService.updateStudent(id, studentDto);
  ...
  public ResponseEntity<Thesis> thesis(@PathVariable("idStudent") Long id, @RequestParam String title) {
